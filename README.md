# CPAD Station Inspection

A .NET Windows Forms application for monitoring CPAD assembly and inspection operations.

## Overview

This repository presents **ATMC.App.KMC.H5.CPAD** as a public portfolio project. The production source code is intentionally not included because the application belongs to an industrial automation environment.

## Project Purpose

The application checks multiple scan and registration results at the CPAD station and exchanges process status with the PLC layer.

## Key Features

- Multi-step scan and registration workflow
- PLC OK/NG signal exchange
- Operator dashboard for station status
- Result folder and database-oriented output flow
