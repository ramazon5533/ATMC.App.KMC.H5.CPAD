# ATMC.App.KMC.H5.CPAD

CPAD assembly/inspection jarayonini nazorat qilish uchun .NET Windows Forms ilovasi.

## Overview

This repository is a public portfolio page for the **CPAD** project. The production source code is intentionally not included because the application belongs to an industrial automation environment.

## What the application does

CPAD stansiyasida bir nechta scan/registration natijalarini tekshiradi va PLC bilan natija almashadi.

## Main features

- Ko'p bosqichli scan va registration nazorati
- PLC OK/NG signal almashinuvi
- Operator uchun dashboard ko'rinishi
- Natijalarni result folder va DB oqimiga yozish
